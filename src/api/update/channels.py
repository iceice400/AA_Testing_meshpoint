...
DEFAULT_CHANNELS: tuple[ReleaseChannel, ...] = (
    ...
    ReleaseChannel(
        id="field-all-features",
        label="Field: all-features integration",
        branch="field/all-features",
        tier=TIER_EXPERIMENTAL,
        description=(
            "Integration branch bundling in-flight PR features. "
            "Expect rough edges; use for field testing only."
        ),
    ),
    ReleaseChannel(
        id="wismesh-node",
